...
# ╔═╡ 31e3d8c0-6c71-11ec-11b1-01e13fc7275f
begin
	using Plots, OrdinaryDiffEq, PlutoUI
	plotly()
end

# ╔═╡ 1338f38f-4b81-433c-b3ed-e5df28077197
...
# ╔═╡ a6af770e-db92-411f-8279-f126309b74d6
...
# ╔═╡ dc6cd35a-2306-4741-ad98-d9779e14abdc
function simulate(ϵ, R₀, τ, tspan)
...
# ╔═╡ 14fa66c3-81a3-48c8-b7b0-098ab75d3f96
function plot_epidemic(epidemic, params)

	p = plot(size=(600, 250))
	
	plot!(epidemic, vars=(0, 1), label="S", lw=2, color="dodgerblue")
	plot!(epidemic, vars=(0, 2), label="I", lw=2, color="red")
	plot!(epidemic, vars=(0, 3), label="R", lw=2, color="gray")

	xlims!(0, 55*params[end])
	ylims!(-0.01, 1.01)

	hline!([1/params[2]], color="black", lw=2, label="", ls=:dash)
...
# ╔═╡ 43118f2d-75c2-4b38-9f49-238319602dc6
function phase_plot(epidemic)

	p = plot(size=(300, 300))

	plot!(epidemic, vars=(1, 2), label="", lw=2, color="dodgerblue")
...
# ╔═╡ b79782d6-8da9-44d6-936d-0b7acae3706d
begin
	...
	# --> Simulate epidemic.
	epidemic = simulate(0.001/100, R₀, τ, tspan)
end;

# ╔═╡ 1675c067-8fce-4209-829b-566b1c769e21
plot_epidemic(epidemic, params)

# ╔═╡ f415c25d-8d26-45bd-add8-ec1aac712498
phase_plot(epidemic)
