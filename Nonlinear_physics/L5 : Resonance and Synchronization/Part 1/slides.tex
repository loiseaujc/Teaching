...
\begin{frame}[t, c]{Resonance}{}
  
\end{frame}

\begin{frame}[t, c]{Resonance}{Damped oscillator with harmonic forcing}
  \begin{minipage}{.68\textwidth}
    \[
    \tcboxmath[colframe=beamer@kthblue, colback=white]{
      \ddot{x} + \delta x + \omega_0^2 x + \beta x^3 = \gamma \cos(\omega t)
      }
    \]

    \bigskip

    Assume $\delta > 0$ (i.e. damped oscillator).
    How does the response of the system evolves as we vary the forcing amplitude $\gamma$ and frequency $\omega$ ?
...
\begin{frame}[t, c]{Resonance}{The limiting case of the harmonic oscillator}
  \begin{minipage}{.68\textwidth}
    \[
    \tcboxmath[colframe=beamer@kthblue, colback=white]{
      \textbf{Harm.\ osc.\ : } \ddot{x} + \omega_0^2 x = \gamma \cos(\omega t)
    }
    \]
  \end{minipage}%
  \hfill
