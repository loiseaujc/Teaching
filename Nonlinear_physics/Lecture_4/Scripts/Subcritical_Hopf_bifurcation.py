...
if __name__ == '__main__':
    ...
    for i, ax in enumerate(axes):
        ...
        if mu[i] > 0:
            ...
            ax.plot(amplitude*np.cos(theta), amplitude*np.sin(theta), ls='--', color='r', lw=2, zorder=2)
        else:
            ax.plot(0, 0, marker='o', color='red', zorder=1, fillstyle='none')
    ...
    plt.savefig('../imgs/subcritical_hopf_bifurcation_phase_plane.pdf', bbox_inches='tight', dpi=300)
