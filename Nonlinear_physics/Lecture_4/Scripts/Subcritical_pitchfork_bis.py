...
if __name__ == '__main__':
    ...
    # --> Define the function.
    f = lambda x, mu : mu*x + x**3 - 0.25*x**5
    ...
    # --> Plot the figure.
    figures = [plt.figure(figsize=(fig_width, fig_width/3)),
               plt.figure(figsize=(fig_width, fig_width/3)),
               plt.figure(figsize=(fig_width, fig_width/3))]
    ...
    for i, fig in enumerate(figures):
        ...
        fig.savefig('../imgs/subcritical_pitchfork_phase_line_bis_%i.pdf' %i, bbox_inches='tight', dpi=300)
